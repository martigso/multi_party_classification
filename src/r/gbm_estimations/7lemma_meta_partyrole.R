...
for(i in sessions){
  ...
  # dir.create(paste0("data/models/7lemma_meta/", gsub("data/folds/", "", i)), recursive = TRUE, showWarnings = FALSE)
  dir.create(paste0("data/gbm_estimations/preds/7lemma_meta/", gsub("data/folds/", "", i)), recursive = TRUE, showWarnings = FALSE)
  dir.create(paste0("data/gbm_estimations/prob_grids/7lemma_meta/", gsub("data/folds/", "", i)), recursive = TRUE, showWarnings = FALSE)
  dir.create(paste0("data/gbm_estimations/var_importance/7lemma_meta/", gsub("data/folds/", "", i)), recursive = TRUE, showWarnings = FALSE)
  
  done_folds <- list.files(paste0("data/gbm_estimations/preds/7lemma_meta/", gsub("data/folds/", "", i)))
  ...
  # Meta variables
  meta_vars <- c("rep_gender", "rep_age", "county", "debate_type", "case_type", "party_role" "language")
  ...
  preds <- lapply(1:length(train), function(x){
    ...
    write_csv(pred, path = paste0("data/gbm_estimations/preds/7lemma_meta/", gsub("data/folds/", "", i), "/", fold, ".csv"))
    write_csv(prob_grid, path = paste0("data/gbm_estimations/prob_grids/7lemma_meta/", gsub("data/folds/", "", i), "/", fold, ".csv"))
    write_csv(imp, path = paste0("data/gbm_estimations/var_importance/7lemma_meta/", gsub("data/folds/", "", i), "/", fold, ".csv"))
